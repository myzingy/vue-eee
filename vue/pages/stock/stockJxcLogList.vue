        ...
        <div slot="main">
            <div >
                ...
                <el-form :inline="true" :model="searchArgs" class="demo-form-inline">
                    ...
                    <el-form-item prop="created_at" sortable="custom" :formatter="moment" :label="$t('操作时间')">
                ...
                <el-table :data="tableData" border style="width: 100%">
                    ...
                    <el-table-column prop="stock_cost" :label="$t('当时库存成本')"> </el-table-column>
                    <el-table-column prop="add_quantity_total" :label="$t('当时累计入库数量')"> </el-table-column>
                    <el-table-column prop="add_cost_total" :label="$t('当时累计入库成本')"> </el-table-column>
                    <el-table-column prop="shipped_quantity_total" :label="$t('当时累计销售数量')"> </el-table-column>
                    <el-table-column prop="shipped_cost_total" :label="$t('当时累计销售成本')"> </el-table-column>
                    <el-table-column prop="drop_quantity_total" :label="$t('当时累计弃件数量')"> </el-table-column>
                    <el-table-column prop="drop_cancel_quantity_total" :label="$t('当时累计弃件取消数量')"> </el-table-column>
                    ...
                    <el-table-column prop="cost" :label="$t('成本')"> </el-table-column>
...
<script>
    ...
    var App= {
        ...
        mounted(){
            ...
            vk.http(uri.getJxcLogType,{},this.then);
        },
        methods: {
            then(json,code){
                switch(code) {
                    case uri.stockJxcLogList.code:
                    ...
                    case uri.getAllStorehouse.code:
                        ...
                        break;
                    case uri.getJxcLogType.code:
                        this.logType = json.data;
                        break;
                }
            },
            getData(){
                vk.http(uri.stockJxcLogList,{searchArgs:this.searchArgs,page:this.page.currentPage,page_size:this.page.pageSize},this.then);
            },
            onSearch(){
