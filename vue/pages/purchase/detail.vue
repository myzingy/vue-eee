        ...
        <template v-for="(item, key) in tableData">
            <tr>
                ...
                <td :colspan="item.key2 ? 1 :3">
                    ...
                    <span v-else v-html="item.val1"></span>
...
<script>
    ...
    let App ={
        ...
        methods : {
            ...
            getInfo(){
                vk.http(uri.purchaseInfo,{id:this.id},this.then);
            },
            formatData(){
                ...
                let purchase_url = '<a href="'+detail.product.oneTemplate.purchase_url+'">'+i18n.t('外采地址')+'</a>';
                ...
                items.push({key1:i18n.t('生产状态'),val1:this.options.statusOptions[detail.status],key2:i18n.t('加急'),val2:'xx'});
                ...
                items.push({key1:i18n.t('采购地址'),val1:purchase_url,key2:i18n.t('开始时间'),val2:this.date('',detail.start_at)});
